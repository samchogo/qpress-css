...
function Qbuilder(config, iframe){
    ...
    function Blocks() {
        ...
        function genToolbar(){
            ...
            return{toolbar:toolbar, toolbarTitle: toolbarTitle, btnUp:btnUp, btnDown:btnDown, btnDim:btnDim,btnConfig:btnConfig, btnCode:btnCode, btnRes:btnRes,btnMoveUp:btnMoveUp, btnMoveDown:btnMoveDown, btnClone:btnClone,btnPlus:btnPlus, btnDelete:btnDelete,btnAdd:btnAdd,btnInbox:btnInbox}
        }
        /* -------
