...
function initBuilder(config) {
    ...
    if(config['tempFiles'] == null) config['tempFiles'] = ['common','components'];
...
function Qbuilder(config, iframe){
    ...
    function Vars(){
        ...
        this.notEbClasses = ['qp-cover','qb-addzone'];
    ...
    function Blocks() {
        ...
        this.btnGap = bar.btnGap;
        this.btnGapPlus = bar.btnGapPlus;
        this.btnGapMinus = bar.btnGapMinus;
        ...
        function genToolbar(){
            ...
            toolbar.classList.add('qb-toolbar');
            toolbar.contentEditable = false;
            var toolbarInner = document.createElement('div')
            toolbarInner.classList.add("qb-toolbar-inner");
            toolbar.appendChild(toolbarInner);
            //title area
            var toolbarTitle = document.createElement('span');
            toolbarTitle.classList.add('qb-toolbar-title');
            toolbarInner.appendChild(toolbarTitle);
            /* --------------------
                more
            ------------------------ */
            var btnMore= document.createElement('span');
            btnMore.classList.add('qb-toolbar-btn','qb-toolbar-more');
            btnMore.innerHTML = '<i class="fas fa-ellipsis-v"></i>';
            btnMore.style.borderRight = "1px solid #c4c4c4";
            toolbarInner.appendChild(btnMore);
                //more inner
                var btnMoreInner = document.createElement('span');
                btnMoreInner.classList.add('qb-toolbar-more-inner');
                btnMore.appendChild(btnMoreInner);
                    // more btn
                    // config button
                    var btnConfig= document.createElement('span');
                    btnConfig.classList.add('qb-toolbar-btn','qp-btn','as-btn-xgray','as-rect');
                    btnConfig.innerHTML = '<i class="fas fa-cog"></i>';
                    btnMoreInner.appendChild(btnConfig);
                    // Responsive Button
                    var btnRes = document.createElement('span');
                    btnRes.classList.add('qb-toolbar-btn','qp-btn','as-btn-xgray','as-rect');
                    btnRes.innerHTML = '<i class="fas fa-mobile-alt"></i>';
                    btnMoreInner.appendChild(btnRes);
                    // Plus button
                    var btnPlus = document.createElement('span');
                    btnPlus.classList.add('qb-toolbar-btn','qp-btn','as-btn-xgray','as-rect');
                    btnPlus.innerHTML = '<i class="far fa-plus-square"></i>';
                    btnMoreInner.appendChild(btnPlus);
                    // dimension button
                    var btnDim= document.createElement('span');
                    btnDim.classList.add('qb-toolbar-btn','qp-btn','as-btn-xgray','as-rect');
                    btnDim.innerHTML = '<i class="fas fa-expand"></i>';
                    btnMoreInner.appendChild(btnDim);
                    // code button
                    var btnCode= document.createElement('span');
                    btnCode.classList.add('qb-toolbar-btn','qp-btn','as-btn-xgray','as-rect');
                    btnCode.innerHTML = '<i class="fas fa-code no-editable"></i>';
                    btnMoreInner.appendChild(btnCode);
                    // Clone button
                    var btnClone = document.createElement('span');
                    btnClone.classList.add('qb-toolbar-btn','qp-btn','as-btn-xgray','as-rect');
                    btnClone.innerHTML = '<i class="far fa-copy no-editable"></i>';
                    btnMoreInner.appendChild(btnClone);
                    // Delete button
                    var btnDelete = document.createElement('span');
                    btnDelete.classList.add('qb-toolbar-btn','qp-btn','as-btn-xgray','as-rect');
                    btnDelete.innerHTML = '<i class="fas fa-trash-alt no-editable"></i>';
                    btnMoreInner.appendChild(btnDelete);

            /* --------------------
                General buttons
            ------------------------ */
            // Drag Button
            var btnDrag = document.createElement('span');
            btnDrag.classList.add('qb-toolbar-btn');
            btnDrag.innerHTML = '<i class="fas fa-arrows-alt"></i>';
            toolbarInner.appendChild(btnDrag);
            // moveUp Button
            var btnMoveUp = document.createElement('span');
            btnMoveUp.classList.add('qb-toolbar-btn');
            btnMoveUp.innerHTML = '<i class="fas fa-angle-double-up"></i>';
            toolbarInner.appendChild(btnMoveUp);
            // moveDown Button
            var btnMoveDown = document.createElement('span');
            btnMoveDown.classList.add('qb-toolbar-btn');
            btnMoveDown.innerHTML = '<i class="fas fa-angle-double-down"></i>';
            toolbarInner.appendChild(btnMoveDown);

            /* --------------------
                gep
            ----------------------- */
            //more inner
            var btnGap = document.createElement('span');
            btnGap.classList.add('qb-toolbar-btn','qb-toolbar-gap');
            btnGap.innerHTML = '<i class="fas fa-grip-lines"></i>';
            btnGap.style.borderLeft ="1px solid #c4c4c4";
            toolbarInner.appendChild(btnGap);
                //gap inner
                var btnGapInner = document.createElement('span');
                btnGapInner.classList.add('qb-toolbar-gap-inner');
                btnGap.appendChild(btnGapInner);
                    var btnGapPlus = document.createElement('span');
                    btnGapPlus.classList.add('qb-toolbar-btn','qp-btn','as-btn-xgray','as-rect');
                    btnGapPlus.innerHTML = '<i class="fas fa-plus-circle"></i>';
                    btnGapInner.appendChild(btnGapPlus);
                    var btnGapMinus = document.createElement('span');
                    btnGapMinus.classList.add('qb-toolbar-btn','qp-btn','as-btn-xgray','as-rect');
                    btnGapMinus.innerHTML = '<i class="fas fa-minus-circle"></i>';
                    btnGapInner.appendChild(btnGapMinus);
            /* --------------------
                selection
            ------------------------ */
            // up Button
            var btnUp = document.createElement('span');
            btnUp.classList.add('qb-toolbar-btn');
            btnUp.innerHTML = '<i class="fas fa-level-up-alt no-editable"></i>';
            btnUp.style.borderLeft ="1px solid #c4c4c4";
            toolbarInner.appendChild(btnUp);
            // down Button
            var btnDown = document.createElement('span');
            btnDown.classList.add('qb-toolbar-btn');
            btnDown.innerHTML = '<i class="fas fa-level-down-alt no-editable"></i>';
            toolbarInner.appendChild(btnDown);

            // add
            var btnAdd = document.createElement('span');
            btnAdd.classList.add('qb-toolbar-btn','qb-toolbar-red');
            btnAdd.innerHTML = '<i class="fas fa-plus"></i>';
            btnAdd.style.borderLeft ="1px solid #c4c4c4";
            toolbarInner.appendChild(btnAdd);
            // inbox
            var btnInbox = document.createElement('span');
            btnInbox.classList.add('qb-toolbar-btn','qb-toolbar-red');
            btnInbox.innerHTML = '<i class="fas fa-inbox"></i>';
            btnInbox.style.borderLeft ="1px solid #c4c4c4";
            toolbarInner.appendChild(btnInbox);


            document.body.appendChild(toolbar);
            return{toolbar:toolbar, toolbarTitle: toolbarTitle, btnDrag:btnDrag, btnUp:btnUp, btnDown:btnDown, btnGap:btnGap, btnGapPlus:btnGapPlus, btnGapMinus:btnGapMinus, btnDim:btnDim,btnConfig:btnConfig, btnCode:btnCode, btnRes:btnRes,btnMoveUp:btnMoveUp, btnMoveDown:btnMoveDown, btnClone:btnClone,btnPlus:btnPlus, btnDelete:btnDelete,btnAdd:btnAdd,btnInbox:btnInbox}
        }
        /* -------
        ...
        this.toolbarReposition = function(){
            if(qb.nowBlock && this.toolbar) {
                ...
                else this.btnAdd.style.display = 'flex';
                if(this.isInsertable(qb.nowBlock) == false) this.btnInbox.style.display = 'none';
                else this.btnInbox.style.display = 'flex';
                if(this.isDraggable(qb.nowBlock) == false) this.btnDrag.style.display = 'none';
                else this.btnDrag.style.display = 'flex';

                if(qb.nowBlock.className.match(/qp-section|qp-wrap/g)) this.btnPlus.style.display = 'inline-block';
                else this.btnPlus.style.display = 'none';

                if(qb.nowBlock.className.match(/qp-grid-cell/g)) this.btnRes.style.display = 'inline-block';
                else this.btnRes.style.display = 'none';

                if(qb.nowBlock.classList.contains("qp-grid") || qb.nowBlock.classList.contains("qp-list")) this.btnConfig.style.display = 'inline-block';
                else this.btnConfig.style.display = 'none';
        ...
        this.getDrop = function(e) {
            ...
            function getDropZone(el) {
                ...
                //     }
                // }
                while (block.isInsertable(el) == false) {
                    if(el.tagName == "BODY") return null;
                    if(el.tagName == "HTML") return null;
                    el = el.parentNode;
                    if (!el) {
        ...
        this.isDraggable = function(el) {
            if(!el) return false;
            if(el.classList.contains('qp-wrap')) return false;
            if(el.classList.contains('qp-section')) return false;
            else return true;
        }
    ...
    function ChangeStyles(){
        ...
        this.changeBottom = function(opt,gap) {
            var nowMg, newMg;
            if(!gap) var gap = 15;
            nowMg = util.removePx(util.currentStyle(qb.nowBlock,'margin-bottom'));
            if(opt == 'plus'){
                newMg = Number(nowMg) + gap;
            } else if(opt == 'minus') {
                newMg = Number(nowMg) - gap;
            }
            qb.nowBlock.style.marginBottom = newMg + 'px';
            util.saveAllToStorage();
        }
        ...
        this.changeBtn = function() {
            var linkUrl = document.getElementById('modalBtnLink').value;
            var linkTarget = document.getElementById('modalBtnTarget').value;
            if(linkUrl) {
                //set Link information
                qb.nowDirect.setAttribute('data-href',linkUrl);
                if(linkTarget) qb.nowDirect.setAttribute('data-target',linkTarget);
                //apply link
                var onClickStr = 'qp.gotoLink(\'' + linkUrl + '\','+ '\'' + linkTarget + '\''+')';
                if(qb.nowDirect.tagName == 'A') {
                    qb.nowDirect.href = linkUrl;
                    qb.nowDirect.target = linkTarget;
                } else {
                    qb.nowDirect.setAttribute("onClick", onClickStr);
                }
            } else {
                if(qb.nowDirect.getAttribute('data-href')) {
                    qb.nowDirect.setAttribute('data-href','none');
                    // qb.nowDirect.removeAttribute('data-href');
                    qb.nowDirect.removeAttribute('data-target');
                    qb.nowDirect.removeAttribute('onClick');
                    qb.nowDirect.removeAttribute('href');
                    qb.nowDirect.removeAttribute('target');
                }
            }

            // onclick Function
            // if(btnFunction) {
            //     qb.nowDirect.setAttribute("onClick", btnFunction);
            // } else {
            //     qb.nowDirect.removeAttribute("onClick");
            // }
            // Link
            // if(document.getElementById('modalBtnLink').value) {
            //     var target = document.getElementById('modalBtnTarget').value;
            //     var onClickStr = 'qp.gotoLink(\'' + document.getElementById('modalBtnLink').value + '\','+ '\'' + target + '\''+')';
            //     if(qb.nowDirect.tagName == 'A') {
            //         qb.nowDirect.href = document.getElementById('modalBtnLink').value;
            //         qb.nowDirect.target = target;
            //     } else {
            //         qb.nowDirect.setAttribute("onClick", onClickStr);
            //     }
            // }
        ...
        this.changeIcon = function() {
            ...
            if(size == 'noset') cleanFontSizeClass(qb.nowDirect);
            else this.addClass(qb.nowDirect, size, 'fontSize');
    ...
    function Modals() {
        ...
        this.openCommon = function(id,target){
            ...
            if(id == 'commonBtn'){
                var linkUrl = qb.nowDirect.getAttribute('data-href');
                var linkTarget = qb.nowDirect.getAttribute('data-target');
                 document.getElementById('modalBtnLink').value = linkUrl;
                 if(linkTarget) document.getElementById('modalBtnTarget').value = linkTarget;
                ...
                // } else {
                //     var link = qb.nowDirect.getAttribute('onclick');
                //     link = link.replace(/qp.gotoLink('/')/g,'');
                // }
            ...
            if(id == 'commonIcon'){
                ...
                if(!size) size = 'noset';
                document.getElementById('modalIconSize').value = size;
        ...
        this.html = function(key){
            ...
            if(key == 'commonImg') {
                html = html + '<input type="text" id="imgUrl" class="qp-input as-w80" placeholder="Image URL">';
                ...
                html = html + '<s></s><select class="qp-input" id="imgShape">';
            ...
            if(key == 'commonBtn') {
                // html = html + '<label>Function on click</label><input type="text" id="btnFunction" class="qp-input as-w100" placeholder="onClick Function"><s></s>'
                 html = html + '<label>Link URL</label><input type="text" id="modalBtnLink" class="qp-input as-w100" placeholder="Href"><s></s>'

                 + '<label class="as-w100">Target Window</label>'
                 + '<select id="modalBtnTarget" class="qp-input">'
                     + '<option value="_self">This Window</option>'
                     + '<option value="_blank">New Window</option> '
                 + '</select><s></s>'
                 + '<label class="as-w100">Text</label><input type="text" id="modalBtnText" class="qp-input as-w70">'
                 + ' <button class="qp-btn as-btn-main qp-dropdown2" id="modalBtnFaBtn"><i class="fab fa-font-awesome-flag"></i>'
                 + '<div class="qp-dropdown-content as-pd qb-divider-icon-list"></div>'
                 + '</button><s></s>'
            ...
            if(key == 'commonDivider') {
                html = html + '<label class="as-w100 as-bold">Divider Icon</label>'
                        + '<input type="text" id="modalDividerIcon" class="qp-input">'
                        + ' <button class="qp-btn as-btn-main qp-dropdown2" id="modalDividerFaBtn"><i class="fab fa-font-awesome-flag"></i>'
                        + '<div class="qp-dropdown-content as-pd qb-divider-icon-list"></div>'
                        + '</button><s></s>'
            ...
            if(key == 'commonIcon') {
                html = html + '<label class="as-w100 as-bold">Icon</label>'
                        + '<input type="text" id="modalIconIcon" class="qp-input as-w80">'
                        + ' <button class="qp-btn as-btn-main qp-dropdown2" id="modalIconFaBtn"><i class="fab fa-font-awesome-flag"></i>'
                        + '<div class="qp-dropdown-content as-pd qb-divider-icon-list"></div>'
                        + '</button><s></s>'
                        + '<label class="as-w100 as-bold">Icon Size</label>'
                        + '<select id="modalIconSize" class="qp-input as-br">'
                            + '<option value="noset">no set</option> '
                        ...
                        + '<div class="qp-qradio" id="modalIconColor">'
                            ...
                            qb.colors.forEach(function(name) {
                                ...
                                // html = html + '<button class="qp-btn as-btn-fit as-btn-parent as-text-'+ name +'" value="'+ btnColor +'" onClick="qp.checkQradio(this, \'qb-color-selected\')"> <i class="fas fa-circle"></i> <span class="as-text-gray">'+ name +'</span></button>';
                                html = html + '<button data-type="iconColor" class="qp-btn as-btn-fit as-btn-'+ name +'" value="'+ iconColor +'" onClick="qp.checkQradio(this, \'as-btn-large\')"> '+ name +'</button>';
                            });
                                html = html + '</div>'
                        + '</div>';
            }
    ...
    function AddEvents(){
        ...
        this.toolbar = function() {
            ...
            block.btnGapPlus.addEventListener("click", function(e){
                exec.changeBottom('plus');
            });
            block.btnGapMinus.addEventListener("click", function(e){
                exec.changeBottom('minus');
            });
            // dimension
        ...
        this.tooltip = function() {
            ...
            addTooltipEvent(block.btnGapPlus,'Increase Bottom Margin');
            addTooltipEvent(block.btnGapMinus,'Decrease Bottom Margin');
        ...
        this.modal = function() {
            ...
            document.getElementById('modalBtnFaBtn').addEventListener("click", function(e){
                let el = document.getElementById('modalBtnFaBtn').getElementsByClassName('qp-dropdown-content')[0];
                if(!el.innerHTML) genIcons(el,'modalBtnText');
                //genIcons(el,'modalDividerIcon');
            });
            ...
            document.getElementById('modalIconFaBtn').addEventListener("click", function(e){
                let el = document.getElementById('modalIconFaBtn').getElementsByClassName('qp-dropdown-content')[0];
                if(!el.innerHTML) genIcons(el,'modalIconIcon');
                //genIcons(el,'modalDividerIcon');
            });
            //divider
            ...
            document.getElementById('modalDividerFaBtn').addEventListener("click", function(e){
                let el = document.getElementById('modalDividerFaBtn').getElementsByClassName('qp-dropdown-content')[0];
                if(!el.innerHTML) genIcons(el,'modalDividerIcon');
                //genIcons(el,'modalDividerIcon');
            });
    ...
    function Utils() {
        this.execIcon = function(target,el) {
            console.log(this);
        }
    ...
    function Templates() {
        ...
        this.closePanel = function() {
          var panel = document.getElementById('panelTemplate');
        ...
        this.live = function() {
            var tempArea = document.getElementById('panelTemplate');
            var select = document.createElement('SELECT');
            select.classList.add('qp-input', 'as-w100', 'as-mg-bottom');
            var option = '<option value="common">Common</option>';
            var tempFiles = config['tempFiles'];
            for(i = 0; i < tempFiles.length; i++) {
                if(tempFiles[i] != 'common') option = option + '<option value="' + tempFiles[i] +'">'+tempFiles[i]+'</option>';
            }
            ...
            select.addEventListener("change", function(e){
                var xmlFile = templatePath  + '/template/' + e.target.value + '.xml';
                loadXML(xmlFile);
            });
        }
