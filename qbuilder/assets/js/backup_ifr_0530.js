...
function Qbuilder(config, iframe){
    ...
    function AddEvents(){
        ...
        this.toolbar = function() {
            ...
            block.btnAdd.addEventListener("click", function(e){
                qb.insType = "add";
                document.getElementById("templateFrame").setAttribute("insType","add");
                template.togglePanel();
            });
            block.btnInbox.addEventListener("click", function(e){
                qb.insType = "inbox";
                document.getElementById("templateFrame").setAttribute("insType","inbox");
                template.togglePanel();
            });
            // Drag & Drop
    ...
    function Templates() {
        ...
        this.genTemplatArea = function() {
            ...
            panel.classList.add('qb-panel-template','as-shade', 'as-border-left');
        ...
        this.showTemplate = function(){
            var ifTemp = document.createElement('iframe');
            ifTemp.setAttribute("id","templateFrame");
            document.getElementById('panelTemplate').overflow = "hidden";
            ifTemp.src = "https://www.getqpress.com/test/template.php";
            document.getElementById('panelTemplate').appendChild(ifTemp);
            ifTemp.onload = function() {
                ifTemp.style.width = '100%';
                ifTemp.style.height = window.innerHeight - document.getElementById(config['docId']).getBoundingClientRect().top + "px";
                ifTemp.style.border = 0;
            }
        }
